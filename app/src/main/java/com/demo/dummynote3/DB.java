...
public class DB {
    private static final String DATABASE_NAME = "t0301.db";
    private static final int DATABASE_VERSION = 1;
    private static final String TABLE_NAME = "dentist_clinic";
    ...
    private static final String KEY_NOTE = "機構名稱";
    private static final String KEY_CREATED = "地址";
